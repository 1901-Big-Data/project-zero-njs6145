	...
	public static Connection getConnection() {
		...
		try {
			...
			in = new FileInputStream(
					"C:\\Users\\Nathaniel\\Documents\\workspace-spring-tool-suite-4-4.1.1.RELEASE\\bank\\src\\main\\resources\\connection.properties");
			props.load(in);
			...
			System.out.println("Unable to get connection to database: " + e);
		} finally {
			try {
				in.close();
			} catch (IOException e) {
